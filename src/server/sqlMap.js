...
var sqlMap = {
    ...
    test:{
        ...
        getGrade:`select student.sname,student.sno,student.classname,new_st.grade,new_st.sumgrade,new_st.testno,new_st.studentanswer
                    from student left join (select * from student_test where testno=?) as new_st on student.sno=new_st.sno`,
        modifyGrade:'update student_test set sumgrade=grade+? where sno=? and testno=?'
    }
}
